...
ERRMSG_ALERT_NOT_ALLOWED_KEYS = "You can't set an alert with those conditions."
ERRMSG_ALERT_NOT_VALID_POSTFIX = 'There is something wrong with a postfix of your condition.'
ERRMSG_ALERT_NOT_VALID_CONDITIONS = 'There is something wrong with your conditions.'
